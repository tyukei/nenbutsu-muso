...
const translations = {
    'ja': {
        ...
        'controlMode': '操作モード',
        'controlPc': 'PC (キーボード)',
        'controlMobileSlide1': 'スマホ (スライド1)',
        'controlMobileSlide2': 'スマホ (スライド2)',
        'controlMobileJoycon': 'スマホ (ジョイコン)',
        'controlDesc': '※デフォルトはスマホ (スライド1)です',
        'submit': '決定',
        'tosAgree': '閉じる',
        'tosTitle': '利用規約',
...
`,
    ...
    'en': {
        ...
        'controlPc': 'PC (Keyboard)',
        'controlMobileSlide1': 'Mobile (Slide 1)',
        'controlMobileSlide2': 'Mobile (Slide 2)',
        'controlMobileJoycon': 'Mobile (Joycon)',
        'controlDesc': '* Default is Mobile (Slide 1)',
        'submit': 'OK',
        'tosAgree': 'Close',
