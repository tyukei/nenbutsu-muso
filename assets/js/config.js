...
const translations = {
    'ja': {
        ...
        'controlMode': '操作モード',
        'controlPc': 'PC (キーボード)',
        'controlMobile': 'スマホ (タップ)',
        'controlDesc': '※デフォルトはPCです',
        'submit': '決定',
        'tosAgree': '同意する',
        'tosTitle': '利用規約',
    ...
    'en': {
        ...
        'unlockSuccess2': '✓ Buddha nature Lev3 unlocked!',
        'unlockSuccessDemon': '✓ Lev Demon unlocked!',
        ...
        'controlMobile': 'Mobile (Tap)',
        'controlDesc': '* Default is PC',
        'submit': 'OK',
        'tosAgree': 'I Agree',
